		...
		public LoginUser() {
			...
			login.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					 SwingUtilities.invokeLater(() -> new MenuForm("TO smart_health_management_system"));
					Users ad = new Users();
			...
			JButton forgotPasswordButton = new JButton("Forgot Password?");
		     forgotPasswordButton.addActionListener(new ActionListener() {
		         public void actionPerformed(ActionEvent e) {
		             ...
		             String email = JOptionPane.showInputDialog(LoginUser.this, "Enter your email:");
		             if (email != null && !email.isEmpty()) {
		                 ...
		                 JOptionPane.showMessageDialog(LoginUser.this, "A password reset link has been sent to your email.");
		             } else {
		                 JOptionPane.showMessageDialog(LoginUser.this, "Please enter a valid email.");
		             }
		         }
		     });
		     ...
		     createAccountButton.addActionListener(new ActionListener() {
		         public void actionPerformed(ActionEvent e) {
		        	...
		        	LoginUser registrationForm = new LoginUser();
