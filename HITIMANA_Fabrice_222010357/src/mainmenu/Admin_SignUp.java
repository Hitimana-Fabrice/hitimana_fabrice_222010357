...
signUp.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==signUp) {
			ad.setName(fnametext.getText());
			ad.setUsername(lnametext.getText());
			ad.setAge(phonetext.getText());
			...
			ad.insertData();
			System.out.print(ad.getName() + " " + ad.getAddress() + " "  + " " + ad.getAddress() + " " + " " +ad.getEmail() + " " +  ad.getUsername() + " " + ad.getPassword() );
		}
	}
});
