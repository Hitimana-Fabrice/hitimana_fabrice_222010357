...
import all_objects.*;
public class HealthyrecordForm  implements ActionListener {
							    JFrame frame;
						...
						//text
							    ...
							    Healthyrecords user=new Healthyrecords();
							        if (e.getSource() == insert_btn) {
							        	 user.setUser_id(pass_txf.getText());
							            user.setDate(email_txf.getText());
							            user.setHeight(email_txf.getText());
							    ...
							    public static void main(String[] args) {
							    	HealthyrecordForm  healthyrecordForm  = new  HealthyrecordForm();
